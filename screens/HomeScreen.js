    ...
    return(        
        <>
            ...
            <View style={{height: '100%', width: '100%', alignItems:'center', borderRadius: 10,}}>
                <View style={{ margin: 10 ,width: '90%', height: '15%', backgroundColor: colors.blu, borderRadius: 10, justifyContent: 'center', alignItems: 'center'}}>
                ...
                <View style={{ margin: 10 ,width: '90%', height: '15%', backgroundColor: colors.yellow, borderRadius: 10, justifyContent: 'center', alignItems: 'center'}}>
                    <Text style={{color: 'white', fontSize: 50}}>13 <Text style={{fontSize: 20 }}>scambi</Text></Text>
                </View>
